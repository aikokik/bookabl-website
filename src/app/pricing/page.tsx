...
const tiers = [
  {
    ...
    highlights: [
      { description: 'API Access to integrate with venue booking platforms' },
      { description: 'Real-time Availability for seamless booking experiences' },
      { description: 'Limited Integrations with select platforms' },
      { description: 'Up to 50 Bookings/Month' },
  ...
  },
  {
    ...
    buttonText: 'Get started',
    highlights: [
      { description: 'Full API Access for integration with all major booking platforms' },
      { description: 'Real-Time Availability across multiple platforms' },
      { description: 'Unlimited Bookings' },
      { description: 'Customizable Booking Experience for your platform' },
      { description: 'Advanced Analytics and Reporting' },
      { description: 'Priority Platform Integrations' },
    ],
    features: [
...
function Header() {
  return (
    <Container className="mt-16">
      <Heading as="h1">Pricing that scales with your business needs.</Heading>
      {/* <Lead className="mt-6 max-w-3xl">
        Companies around the world are streamlining their booking systems with Bookabl. Sign up today and start managing bookings smarter.
      </Lead> */}
    </Container>
  )
}
    ...
    <div className="-m-2 grid grid-cols-1 rounded-4xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:w-full max-lg:max-w-md">
      <div className="grid grid-cols-1 rounded-4xl p-2 shadow-md shadow-black/5">
        <div className="rounded-3xl bg-white p-10 pb-9 shadow-2xl ring-1 ring-black/5">
          ...
          <div className="mt-8">
            <Button href={tier.href}>{tier.buttonText}</Button>
          </div>
          <div className="mt-8">
